window.addEventListener('load', function () {
    ...
    //los datos que el usuario cargará de la nueva estudiante
    ...
    formulario.addEventListener('submit', function (event) {
       ...
       //creamos un JSON que tendrá los datos del nuevo estudiante
        ...
        //invocamos utilizando la función fetch la API estudiantes con el método POST que guardará
        //el estudiante que enviaremos en formato JSON
