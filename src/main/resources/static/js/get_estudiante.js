window.addEventListener('load', function () {
    (function(){
      ...
      //recorremos la colección de estudiantes del JSON
         for(estudiante of data){
            ...
            //cada fila tendrá un id que luego nos permitirá borrar la fila si eliminamos al estudiante
            ...
            //de llamar a la API para eliminar una estudiante
            let deleteButton = '<button' +
                                      ' id=' + '\"' + 'btn_delete_' + estudiante.id + '\"' +
                                      ' type="button" onclick="deleteBy('+estudiante.id+')" class="btn btn-danger btn_delete">' +
                                      '&times' +
                                      '</button>';
            ...
            let updateButton = '<button' +
                                      ' id=' + '\"' + 'btn_id_' + estudiante.id + '\"' +
                                      ' type="button" onclick="findBy('+estudiante.id+')" class="btn btn-info btn_id">' +
                                      estudiante.id +
                                      '</button>';
            ...
            studentRow.innerHTML = '<td>' + updateButton + '</td>' +
                    '<td class=\"td_first_name\">' + estudiante.nombre.toUpperCase() + '</td>' +
                    '<td class=\"td_last_name\">' + estudiante.apellido.toUpperCase() + '</td>' +
                    '<td>' + deleteButton + '</td>';
        };
    ...
    (function(){
      ...
      if (pathname == "/estudianteList.html") {
